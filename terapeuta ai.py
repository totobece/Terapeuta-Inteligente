...
openai.api_key = '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'

#input of the ai
messages = [
    #{"role": "system", "content": "You are a therapist. Try to gave comfort and examples of how i can across with my problem"}
    {"role": "system", "content": "Your are a Therapist, act as caring and understanding as possible"}
]
